...
function add(list) {
  ...
  function createShots(data) {
    ...
    if (data.length > 0) {
      ...
      data.forEach(function(shot, index) {
        var id = shot.id;
        var url = shot.html_url;
        var largeImage = shot.images.hidpi;
        var mediumImage = shot.images.normal;
        var teaserImage = shot.images.teaser;
